...
# a coluna que nos interessa � a �ltima, a qual contem os resultados
...
'2 - n�mero m�dio de gols marcados pelo mandante e pelo visitante
...
# as incertezas ser�o calculadas pela binomial
...
# calculo agora as frequ�ncias relativas
frel_0 <- cont_0/N
frel_1 <- cont_1/N
frel_2 <- cont_2/N
frel_3 <- cont_3/N
...
#as incertezas das frequ�ncias v�o ser dadas por:
sd_f0 <- sd_c0/N
sd_f1 <- sd_c1/N
sd_f2 <- sd_c2/N
sd_f3 <- sd_c3/N
...
'6 - Valor m�dio da soma e sua incerteza'
